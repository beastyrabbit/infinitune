...
import type { DeviceRole, RoomInfo } from "./protocol.js";
...
export class RoomManager {
	...
	createRoom(id: string, name: string, playlistKey: string): Room {
		...
		console.log(`[room-manager] Created room "${id}" (${name}) → playlist ${playlistKey}`);
		return room;
	}
	...
	/** Get all rooms that have a given playlist key (for Convex polling). */
