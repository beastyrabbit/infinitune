    ...
    <div className="font-mono min-h-screen bg-gray-950 text-white">
      ...
      <header className="border-b-4 border-white/20 bg-black">
        <div className="flex items-center justify-between px-4 py-3">
          <h1 className="text-3xl font-black tracking-tighter uppercase sm:text-5xl">SETTINGS</h1>
          <button
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="text-xs font-bold uppercase text-white/40">Ollama URL</label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="text-xs font-bold uppercase text-white/40">ACE-Step URL</label>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="text-xs font-bold uppercase text-white/40">ComfyUI URL</label>
            ...
            <div>
              ...
              {textProvider === 'ollama' && textModels.length > 0 ? (
                ...
                <Input
                  ...
                  placeholder={
                    textProvider === 'openrouter' ? 'GOOGLE/GEMINI-2.5-FLASH' : 'LLAMA3.1:8B'
                  }
                  value={textModel}
            ...
            {imageProvider === 'comfyui' ? (
              <div>
                <p className="text-[10px] font-bold uppercase text-white/30 mt-1">
                  USING BUILT-IN Z-IMAGE-TURBO (LUMINA2) WORKFLOW — 4 STEPS, 496x496, WEBSOCKET
                </p>
              </div>
            ) : (
              <div>
