...
export function getCoverColors(title: string, artistName: string): [string, string, string] {
...
export type CoverPattern = 'stripes' | 'grid' | 'diagonal' | 'blocks' | 'circle' | 'cross'

export function getCoverPattern(title: string): CoverPattern {
  const patterns: CoverPattern[] = ['stripes', 'grid', 'diagonal', 'blocks', 'circle', 'cross']
