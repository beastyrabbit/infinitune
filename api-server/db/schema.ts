...
export const playlists = sqliteTable(
	"playlists",
	{
		...
		llmProvider: text("llm_provider").notNull(), // "ollama" | "openrouter"
		llmModel: text("llm_model").notNull(),
		mode: text("mode").notNull().default("endless"), // "endless" | "oneshot"
		...
		steerHistory: text("steer_history"), // JSON array
	},
...
export const songs = sqliteTable(
	"songs",
	{
		...
		generationStartedAt: integer("generation_started_at", { mode: "number" }),
